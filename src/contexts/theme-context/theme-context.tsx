...
import { getThemeConfig, getThemedComponent, THEME_MODE } from 'src/theme/theme';
...
export function ThemeCustomProvider({ children }: BaseContextProps) {
    ...
    const theme = useMemo<Theme>(() => {
        ...
        return responsiveFontSizes(deepmerge(_t, getThemedComponent(_t)), { breakpoints: ['xs', 'xsm'] });
    }, [mode]);
    ...
    return (
        <ThemeContext.Provider value={{ toggleThemeMode, mode, breakPoint: { downMD, downXSM } }}>
